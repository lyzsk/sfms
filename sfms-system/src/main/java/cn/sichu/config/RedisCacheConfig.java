...
public class RedisCacheConfig {
     ...
     * @return org.springframework.data.redis.cache.RedisCacheManager {@link RedisCacheManager}
     * @author sichu huang
     * @since 2024/10/17 16:37:31
     */
    @Bean
    public RedisCacheManager redisCacheManager(RedisConnectionFactory redisConnectionFactory,
        ...
        return RedisCacheManager.builder(
            ...
            .cacheDefaults(redisCacheConfiguration(cacheProperties)).build();
    }
