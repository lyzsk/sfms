package cn.sichu.system.core.security.service;
...
public class PermissionService {
    ...
    public Set<String> getRolePermsFormCache(Set<String> roleCodes) {
        ...
        List<Object> rolePermsList = redisTemplate.opsForHash()
        ...
        for (Object rolePermsObj : rolePermsList) {
            if (rolePermsObj instanceof Set) {
                @SuppressWarnings("unchecked") Set<String> rolePerms = (Set<String>)rolePermsObj;
