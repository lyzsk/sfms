package cn.sichu.system.core.filter;
...
public class RateLimiterFilter extends OncePerRequestFilter {
    ...
    public boolean rateLimit(String ip) {
        ...
        Object systemConfig =
            configService.getSystemConfig(RedisConstants.IP_QPS_THRESHOLD_LIMIT_KEY);
        long limit = 10;
        ...
        // else {
        //     log.warn(
        //         "[RedisRateLimiterFilter.rateLimit]系统配置中未配置IP请求限制QPS阈值配置,使用默认值:{},请检查配置项:{}",
