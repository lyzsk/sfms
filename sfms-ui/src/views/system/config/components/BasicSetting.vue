                    ...
                    >
                        <template #upload-button>
                            ...
                            >
                                ...
                                <div
                                    v-else
                                    class="arco-upload-picture-card logo"
                                >
                    ...
                    >
                        <template #upload-button>
                            ...
                            >
                                ...
                                <div
                                    v-else
                                    class="arco-upload-picture-card favicon"
                                >
                                    <div class="arco-upload-picture-card-text">
                                        <icon-upload />
                                    </div>
