            ...
            >
                ...
                >
                    ...
                    <template #custom-right>
                        <a-button
                            v-permission="['system:dict:item:add']"
                            type="primary"
                            @click="onAdd"
                        >
                    ...
                    <template #action="{ record }">
                        <a-space>
                            <a-link
                                v-permission="['system:dict:item:update']"
...
const {
    ...
    search,
    handleDelete,
} = useTable((page) => listDictItem({ ...queryForm, ...page }), {
    immediate: false,
});
