<template>
    <div class="gi-table" :class="{ 'gi-table--fullscreen': isFullscreen }">
        ...
        <div
            class="gi-table__body"
            :class="`gi-table__body-pagination-${attrs['page-position']}`"
        >
...
.gi-table {
    ...
    &__container {
        ...
        // 控制table高度占满
        :deep(
                .arco-table-border:not(.arco-table-border-cell)
