...
import cn.sichu.apidoc.handler.BaseEnumParameterHandler;
import cn.sichu.apidoc.handler.OpenApiHandler;
...
public class SpringDocAutoConfiguration implements WebMvcConfigurer {
    ...
    public OpenAPI openApi(ProjectProperties projectProperties,
        ...
        if (null != components) {
            ...
            if (MapUtil.isNotEmpty(securitySchemeMap)) {
                ...
                List<String> list =
                    securitySchemeMap.values().stream().map(SecurityScheme::getName).toList();
    ...
    public void postConstruct() {
        log.debug("[SFMS] - Auto Configuration 'ApiDoc' completed initialization.");
    }
}
